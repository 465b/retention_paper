...
\begin{abstract}
    ...
    We find that vertial migration especially rising favors the retention, fast sinking does not.
    ...
    \texttt{decide how to use "doubling time" and "growth rate" consistently}
    \texttt{"Just as a superficial reading would say its easy to be retained with normal doubling times with growth rates much smaller than those explored.?"}
\end{abstract}
